...
/**
    ...
    fun <T> property(initial: T): GraphProperty<T> = ConceptGraphPropertyImpl(this) { initial }
...
/**
    ...
    fun <T> lazyProperty(initial: () -> T): GraphProperty<T> = ConceptGraphPropertyImpl(this, initial)
