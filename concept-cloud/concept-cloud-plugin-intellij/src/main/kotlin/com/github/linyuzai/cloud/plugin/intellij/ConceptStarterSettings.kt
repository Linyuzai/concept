...
/*@Label*//*
 String? = null
    var serverUrlDialogTitle: */
/*@DialogTitle*//*
 String? = null
    var dependenciesLabel: */
/*@Label*//*
 String? = null
    var selectedDependenciesLabel: */
/*@Label*//*
 String? = null
    var noDependenciesSelectedLabel: */
/*@Label*//*
 String? = null
    var frameworkVersionLabel: */
/*@Label*//*
 String? = null
}
...
class ConceptLibraryLink(
    val type: ConceptLibraryLinkType,
    */
/*@NlsSafe*//*
...
open class ConceptCommonStarterContext : UserDataHolderBase() {
