...
open class ConceptSwingComponentWrapper(private val c: JComponent) : ComponentWrapper {
    ...
    override fun getParent(): ContainerWrapper? {
        ...
        return ConceptSwingContainerWrapper(p)
    }
    ...
    override fun getVisualPadding(): IntArray? {
        ...
        val paddings = border.getBorderInsets(component)
        ?: return null
