...
open class ConceptLayoutBuilder @PublishedApi internal constructor(@PublishedApi internal val builder: ConceptLayoutBuilderImpl) :
    ConceptRowBuilder by builder.rootRow {
    ...
    inline fun buttonGroup(
        ...
        crossinline init: ConceptLayoutBuilder.() -> Unit
    ): ButtonGroup {
...
@PublishedApi internal constructor(private val prop: ConceptPropertyBinding<T>) {
    ...
    fun ConceptCellBuilder<JBRadioButton>.bindValue(value: T): ConceptCellBuilder<JBRadioButton> =
        bindValueToProperty(prop, value)
}


class ConceptRowBuilderWithButtonGroupProperty<T : Any>
@PublishedApi internal constructor(
    private val builder: ConceptRowBuilder,
    private val prop: ConceptPropertyBinding<T>
) : ConceptRowBuilder by builder {

    fun ConceptRow.radioButton(
        text: String,
        value: T,
        @Nls comment: String? = null
    ): ConceptCellBuilder<JBRadioButton> {
...
private fun <T> ConceptCellBuilder<JBRadioButton>.bindValueToProperty(
    prop: ConceptPropertyBinding<T>,
    value: T
): ConceptCellBuilder<JBRadioButton> = apply {
