...
internal class ConceptMigLayoutBuilder(val spacing: ConceptSpacingConfiguration) : ConceptLayoutBuilderImpl {
    ...
    override val rootRow = ConceptMigLayoutRow(parent = null, builder = this, indent = 0)
    ...
    val defaultComponentConstraintCreator = ConceptDefaultComponentConstraintCreator(spacing)
    ...
    private fun collectPhysicalRows(rootRow: ConceptMigLayoutRow): List<ConceptMigLayoutRow> {
        val result = mutableListOf<ConceptMigLayoutRow>()
        fun collect(subRows: List<ConceptMigLayoutRow>?) {
            subRows?.forEach { row ->
    ...
    private fun configureGapBetweenColumns(rootRow: ConceptMigLayoutRow) {
    ...
    private fun configureGapsBetweenRows(physicalRows: List<ConceptMigLayoutRow>) {
    ...
    private fun getRowType(row: ConceptMigLayoutRow): RowType {
