...
abstract class ConceptCommonStarterInitialStep(
    protected val wizardContext: WizardContext,
    private val starterContext: ConceptCommonStarterContext,
    private val moduleBuilder: ModuleBuilder,
    protected val parentDisposable: Disposable,
    protected val starterSettings: ConceptStarterWizardSettings
) : ModuleWizardStep() {
    ...
    protected val languageProperty: GraphProperty<ConceptStarterLanguage> = propertyGraph.lazyProperty { starterContext.language }
    protected val projectTypeProperty: GraphProperty<ConceptStarterProjectType> = propertyGraph.lazyProperty {
        starterContext.projectType ?: ConceptStarterProjectType("unknown", "")
    }
    protected val testFrameworkProperty: GraphProperty<ConceptStarterTestRunner> = propertyGraph.lazyProperty {
        starterContext.testFramework ?: ConceptStarterTestRunner("unknown", "")
    }
    protected val applicationTypeProperty: GraphProperty<ConceptStarterAppType> = propertyGraph.lazyProperty {
        starterContext.applicationType ?: ConceptStarterAppType("unknown", "")
    }
        ...
        row(JavaStartersBundle.message("title.project.group.label")) {
            ...
            textField()
                ...
                .withSpecialValidation(CHECK_NOT_EMPTY, CHECK_NO_WHITESPACES, CHECK_GROUP_FORMAT, CHECK_NO_RESERVED_WORDS,
                    *getCustomValidationRules(com.intellij.ide.starters.shared.GROUP_ID_PROPERTY))
        }.bottomGap(BottomGap.SMALL)
        ...
        row(JavaStartersBundle.message("title.project.artifact.label")) {
            ...
            textField()
                ...
                .withSpecialValidation(CHECK_NOT_EMPTY, CHECK_NO_WHITESPACES, CHECK_ARTIFACT_SIMPLE_FORMAT, CHECK_NO_RESERVED_WORDS,
                    *getCustomValidationRules(com.intellij.ide.starters.shared.ARTIFACT_ID_PROPERTY))
        }.bottomGap(BottomGap.SMALL)
    }
